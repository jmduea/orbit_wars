---
name: java-reviewer
description: Java code review specialist with embedded style and safety rules. Use when: reviewing Java code, Java best practices, type safety, Java-specific patterns, idiomatic Java, Spring framework review.
model: inherit
readonly: true
---

> Synced from `.github/agents/java-reviewer.agent.md`. Edit `.github/agents/` and re-run `scripts/sync_omg_cursor.py`.
