---
name: architect
description: Strategic Architecture & Debugging Advisor (READ-ONLY). Use when: architecture analysis, code diagnosis, debugging root causes, implementation verification, structural recommendations, system design review.
model: inherit
readonly: true
---

> Synced from `.github/agents/architect.agent.md`. Edit `.github/agents/` and re-run `scripts/sync_omg_cursor.py`.
