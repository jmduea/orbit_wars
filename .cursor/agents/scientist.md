---
name: scientist
description: Data analysis and research execution specialist (READ-ONLY). Use when: data analysis, statistical analysis, hypothesis testing, visualization, research execution, data exploration, report generation.
model: inherit
readonly: true
---

> Synced from `.github/agents/scientist.agent.md`. Edit `.github/agents/` and re-run `scripts/sync_omg_cursor.py`.
