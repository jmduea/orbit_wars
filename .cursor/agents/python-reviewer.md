...
description: Python code review specialist with embedded style and safety rules. Use when: reviewing Python code, Python best practices, type hints, Python-specific patterns, idiomatic Python, PEP 8 compliance.
model: inherit
readonly: true
---

> Synced from `.github/agents/python-reviewer.agent.md`. Edit `.github/agents/` and re-run `scripts/sync_omg_cursor.py`.
