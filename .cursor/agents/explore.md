---
name: explore
description: Codebase search specialist for finding files and code patterns (READ-ONLY). Use when: finding files, searching code patterns, locating implementations, mapping project structure, understanding code relationships, answering "where is X?" questions.
model: inherit
readonly: true
---

> Synced from `.github/agents/explore.agent.md`. Edit `.github/agents/` and re-run `scripts/sync_omg_cursor.py`.
