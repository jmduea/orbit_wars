...
description: TypeScript code review specialist with embedded style and safety rules. Use when: reviewing TypeScript code, TypeScript best practices, type safety, TypeScript-specific patterns, idiomatic TypeScript, strict mode compliance.
model: inherit
readonly: true
---

> Synced from `.github/agents/typescript-reviewer.agent.md`. Edit `.github/agents/` and re-run `scripts/sync_omg_cursor.py`.
