---
name: critic
description: Work plan and code review expert - thorough, structured, multi-perspective (READ-ONLY). Use when: plan review, code review quality gate, gap analysis, pre-mortem analysis, final approval checks, finding flaws in proposals, challenging assumptions.
model: inherit
readonly: true
---

> Synced from `.github/agents/critic.agent.md`. Edit `.github/agents/` and re-run `scripts/sync_omg_cursor.py`.
