...
description: Simplifies and refines code for clarity, consistency, and maintainability. Use when: code simplification, reducing complexity, cleaning up code, improving readability, removing redundancy, refactoring for clarity.
model: inherit
readonly: false
---

> Synced from `.github/agents/code-simplifier.agent.md`. Edit `.github/agents/` and re-run `scripts/sync_omg_cursor.py`.
