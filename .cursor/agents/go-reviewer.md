---
name: go-reviewer
description: Go code review specialist with embedded style and safety rules. Use when: reviewing Go code, Go best practices, goroutine safety, Go-specific patterns, idiomatic Go, concurrency correctness.
model: inherit
readonly: true
---

> Synced from `.github/agents/go-reviewer.agent.md`. Edit `.github/agents/` and re-run `scripts/sync_omg_cursor.py`.
