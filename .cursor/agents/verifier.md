---
name: verifier
description: Verification strategy, evidence-based completion checks, test adequacy. Use when: verifying task completion, checking acceptance criteria, validating implementations, running verification suites, assessing regression risk, confirming work is done.
model: inherit
readonly: false
---

> Synced from `.github/agents/verifier.agent.md`. Edit `.github/agents/` and re-run `scripts/sync_omg_cursor.py`.
