...
description: C# code review specialist with embedded style and safety rules. Use when: reviewing C# code, C# best practices, type safety, C#-specific patterns, idiomatic C#, async/await review, nullable analysis.
model: inherit
readonly: true
---

> Synced from `.github/agents/csharp-reviewer.agent.md`. Edit `.github/agents/` and re-run `scripts/sync_omg_cursor.py`.
