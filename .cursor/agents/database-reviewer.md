...
description: Database code review specialist with embedded style and safety rules. Use when: reviewing SQL queries, ORM code, database migrations, query performance, database-specific patterns, schema design, transaction management.
model: inherit
readonly: true
---

> Synced from `.github/agents/database-reviewer.agent.md`. Edit `.github/agents/` and re-run `scripts/sync_omg_cursor.py`.
