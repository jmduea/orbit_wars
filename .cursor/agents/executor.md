---
name: executor
description: Focused task executor for implementation work. Use when: implementing code changes, writing features, fixing bugs, executing plan steps, making code modifications, building functionality.
model: inherit
readonly: false
---

> Synced from `.github/agents/executor.agent.md`. Edit `.github/agents/` and re-run `scripts/sync_omg_cursor.py`.
