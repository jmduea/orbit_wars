---
name: rust-reviewer
description: Rust code review specialist with embedded style and safety rules. Use when: reviewing Rust code, Rust best practices, memory safety, Rust-specific patterns, idiomatic Rust, ownership and borrowing.
model: inherit
readonly: true
---

> Synced from `.github/agents/rust-reviewer.agent.md`. Edit `.github/agents/` and re-run `scripts/sync_omg_cursor.py`.
