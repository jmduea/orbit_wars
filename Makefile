...
test-domain-artifacts:
	uv run --group dev pytest tests/test_artifact_pipeline.py tests/test_promotion.py tests/test_replay.py tests/test_kaggle_submission_packager.py tests/test_checkpoint_compat.py -m "not slow and not jax"
